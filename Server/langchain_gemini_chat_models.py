...
"""
        ...
        if raw_system_message:
            messages.append({"role": "user", "parts": _convert_to_parts(raw_system_message.content)})
            if role != "model":
                messages.append({"role": "model", "parts": [genai.types.PartDict(text="OK")]})
...
Supported examples:
    ...
    def _prepare_params(
        ...
        params = {"generation_config": gen_config, "safety_settings": safety_settings, **kwargs}
        return params
