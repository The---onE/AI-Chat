package com.xmx.ai.gemini.view
...
import coil.load
import com.xmx.ai.R
import com.xmx.ai.gemini.adapter.GeminiContentAdapter
import com.xmx.ai.gemini.viewModel.GeminiViewModel
import com.xmx.ai.database.entity.ContentEntity
import com.xmx.ai.databinding.ActivityGeminiBinding
...
class GeminiActivity : AppCompatActivity() {
    ...
    companion object {
        var instance: GeminiActivity? = null
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.geminiInsertCheck.observe(this) {
            if (it == true) {
                viewModel.getContentData(roomId)
                binding.loading.visibility = View.INVISIBLE
            }
    ...
    private fun setContentListRV() {
        val contentAdapter = GeminiContentAdapter(this, contentDataList)
        ...
        contentAdapter.chatLayoutClick = object : GeminiContentAdapter.ChatLayoutClick {
            override fun onLongClick(view: View, position: Int) {

                val builder = AlertDialog.Builder(this@GeminiActivity)
            ...
            override fun onDoubleClick(view: View, position: Int) {
                val intent = Intent(this@GeminiActivity, DetailActivity::class.java)
