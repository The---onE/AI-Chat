package com.xmx.ai.chatgpt.adapter
...
class GptContentAdapter(val context : Context, private val dataSet : List<ContentEntity>) : RecyclerView.Adapter<GptContentAdapter.ViewHolder>() {
    ...
    override fun getItemViewType(position: Int): Int {
        return if (dataSet[position].ai == 1) { // Gpt
            Gpt
        } else {
            User
        }
