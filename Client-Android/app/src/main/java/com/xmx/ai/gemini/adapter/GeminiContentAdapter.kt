package com.xmx.ai.gemini.adapter
...
class GeminiContentAdapter(val context : Context, private val dataSet : List<ContentEntity>) : RecyclerView.Adapter<GeminiContentAdapter.ViewHolder>() {

    companion object {
        private const val Gemini = 1
